...
**Post-build increment (2026-07-17, D-035):** `apps/web/src/ui` primitives layer completed to a production component system — Field/Textarea/Checkbox/Switch (context-wired forms), Tabs/Menu/Tooltip/Drawer (APG keyboard patterns, motion-law compliant), ErrorState, shared floating positioning, `ui/README.md` architecture+usage doc. Additive only; web suite now 1,024 green.
