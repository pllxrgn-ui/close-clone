...
|---|---|---|---|---|---|---|---|
| 1 | Phase 2 email engine | `D:\CODE\NEW\close-clone` | `main` | 2a✅ 2b✅ →2c→2d→2e→2f | `wf_74b6bf62-c14` | `phase-2-email-engine-wf_74b6bf62-c14.js` | 2b COMPLETE (feeceae/752799b/f6fdc2e — salvage verified prior engine correct; deep review deferred to Gate 2). 2c running, 2nd attempt (ingest/matcher/email-services salvaged; delete derisk-tmp.mjs). 2d/2e prompts carry 2b's seam notes |
| 2 | Web foundation | `D:\CODE\NEW\close-clone-web` | `web-foundation` | W1✅→W2→W3→W4→W5→W6 | `wf_f5c002e0-3b2` | `web-foundation-wf_f5c002e0-3b2.js` | W1 COMPLETE (5 commits incl. axe smoke, dev-login gate). W2 running, 2nd attempt (worktree was clean — no salvage needed). W3 prompt carries D-023 reference endpoints; W5 prompt now includes MSW env-gating + real-mode proxy |
